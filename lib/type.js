import { MetaProperty, MetaPropReader, defaultProp } from "./meta-props.js";
export const typeProp = new MetaProperty('type', undefined)
...
export const parseProp = new MetaProperty('parse', undefined)
...
export const stringifyProp = new MetaProperty('stringify', v => v == undefined ? '' : `${v}`)
...
export const validateProp = new MetaProperty('validate', undefined)
    .addDependency(typeProp, 0, type => {
    switch (type) {
        case String:
