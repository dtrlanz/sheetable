...
namespace Sheetable {
    export function table<T extends MetaTagged>(Constructor: { new (): T }) {
        return class ServerTable extends Sheetable.Table<T> {
...
function getSheet(info: Sheetable.SheetInfo): { spreadsheet: Spreadsheet, sheet: Sheet, orientation: Sheetable.Orientation } {
...
function getSheetColumns(info: Sheetable.SheetInfo = {}, columns: number[], rowStart: number, rowStop?: number): Sheetable.SheetColumns {
