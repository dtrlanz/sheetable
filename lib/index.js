import { MetaPropReader, MetaProperty } from "./meta-props.js";
...
export class Index {
    ...
    indexTitles;
    map = new TupleMap();
    constructor(ctor, header, context) {
        this.ctor = ctor;
    ...
    *getIndexedPropsFromObjects(objects) {
        for (const obj of objects) {
            yield [this.indexKeys.map(k => obj[k]), obj];
        }
    }
    /**
     ...
     */
    *getIndexedPropsFromRows(rows, colNumbers) {
     ...
     */
    initAll(indexedProps, initValue) {
...
export function getIndexKeys(ctor, context) {
