...
export class SheetClient {
    ...
    static fromSheet(sheet, sheetName, orientation = 'normal', rowStart, rowStop, colStart, colStop) {
        ...
        setTimeout(() => resolve(server.processRequest({ orientation, ...req })))), sheetName, undefined, orientation, rowStart, rowStop ?? sheet.getLastRow() + 1, colStart, colStop ?? sheet.getLastColumn() + 1);
    }
